 ...
 * calls the Draw class to draw a crude visual of their placement.
 * The Ui
 * chooses the rooms randomly and later the number of rooms can be fixed.
 *
 * adjusting the deep value let's you control the depth of the cave in increments 
 * of 100.
 * 
...
public class Ui {
    ...
    public static void main(String[] args) {
        ...
        d.drawRooms(Color.YELLOW, subCaves);
